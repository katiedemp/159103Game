...
public class TankGame extends GameEngine {
	...
	public void updateTank(double dt, Tank tank) {
		if (tank.getHealth() == 0){
			...
			createExplosion(playerOne.getPositionX(), playerOne.getPositionY());
			Score++;
	...
	public void updateExplosion(double dt) {
		...
		if(explosionActive) {
			...
			// Set explosion frame
			explosionFrame = getAnimationFrame(explosionTimer, explosionDuration, 32);
		}
	}
	...
	public void drawExplosion() {
		...
		if(explosionActive) {
			...
			drawImage(explosionImages[explosionFrame], -30, -30, 60, 60);
	...
	public void drawWaveLevel(int Wave){
		changeColor(white);
		drawText(452, 50, "Wave:", "Arial", 20);
		drawText(512, 50, Integer.toString(Wave), "Arial", 20);
	}
	
	// Health
	public void drawHealthBar(Tank tank){
		changeColor(white);
		drawText(5, 50, "Health:", "Arial", 20);
		changeColor(red);
		drawSolidRectangle(70, 30, tank.getHealth(), 25);
	}
	...
	public void drawScoreBoard(int Score){
		changeColor(white);
		drawText(914, 50, "Score:", "Arial", 20);
		drawText(974, 50, Integer.toString(Wave), "Arial", 20);
	}
	...
	public void init() {
		...
		//Load spritesheet
		spritesheet = loadImage("Bullets\\spritesheet.png");
	...
	public void paintHUD() {
		drawImage(hud, 0, 0, width(), height());
	}
	...
	public void keyPressed(KeyEvent e) {
		...
		if(e.getKeyCode() == KeyEvent.VK_SPACE) {
			...
			fireLaser(playerOne);
			playerOne.setHealth(playerOne.getHealth()-20); //!! FOR TESTING
		}
